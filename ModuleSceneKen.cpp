...
update_status ModuleSceneKen::Update()
{
	...
	App->renderer->Blit(graphics, 0, 0, &background, 4.0f); // sea and sky
	App->renderer->Blit(graphics, 560, 8, &(flag.GetCurrentFrame()), 4.0f); // flag animation

	// TODO 3: Draw the ship. Be sure to tweak the speed.
	App->renderer->Blit(graphics, 0, 0, &red_ship, 4.0f); // red ship

	// TODO 6: Draw the girl. Make sure it follows the ship movement!
	App->renderer->Blit(graphics, 192, 104, &(girl.GetCurrentFrame()), 4.0f); // girl animation
